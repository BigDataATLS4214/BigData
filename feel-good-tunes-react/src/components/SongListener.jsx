        ...
        <div className='song-container'>
            {loaded && <div className='music-player' >
                ...
                {playlist !== "" && <div className='music-player-controls'>
                    ...
                    <p className='music-player-details-text'> Features songs from as early as {playlist[playlistID].earliestReleaseYear} to as recent as {playlist[playlistID].latestReleaseYear}.</p>
                    <SpotifyPlayer
                        token={sessionToken}
