...
function App() {
  ...
  return (
    <div>
      ...
      {(sessionToken !== "" && page === 'scanMood' )? <Cam setPage={setPage} setPreviousPage={setPreviousPage} setEmotion={setEmotion}/> : null}
      {(sessionToken !== "" && page === 'sayMood' )? <Mic setPage={setPage} setPreviousPage={setPreviousPage} setEmotion={setEmotion}/> : null}
    </div>
  );
}
