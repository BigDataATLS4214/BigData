...
msd_subset_path='/Users/annechen/Downloads/MillionSongSubset'
# msd_subset_data_path=os.path.join(msd_subset_path,'data')
msd_subset_db_path='/Users/annechen/Documents/School/Spring 2023/BigData/MSDB_playground'
assert os.path.isdir(msd_subset_path),'wrong path' # sanity check

# path to the Million Song Dataset code
# CHANGE IT TO YOUR LOCAL CONFIGURATION
msd_code_path='/Users/annechen/Downloads/MillionSongSubset'
...
conn = sqlite3.connect(os.path.join(msd_subset_db_path,
                                    'track_metadata.db'))
...
most_pop_aid = sorted(files_per_artist,
                      key=files_per_artist.__getitem__, reverse=True)[0]
